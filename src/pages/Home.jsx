...
import { ArrowRight, Cpu, Microscope, FlaskConical } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="home-page-wrapper">
        ...
        <div className="container hero-container">
          ...
          <div className="hero-graphic-container">
            <svg viewBox="0 0 400 400" className="hero-polymer-svg ani-float">
              ...
              {/* Outer mesh */}
              <circle cx="200" cy="200" r="160" fill="none" stroke="url(#glowG)" strokeWidth="2" opacity="0.15" strokeDasharray="8 4" className="ani-spin-slow" />
              <circle cx="200" cy="200" r="120" fill="none" stroke="var(--accent-primary)" strokeWidth="1" opacity="0.3" />
              ...
              <g className="ani-spin-slow" style={{ transformOrigin: '200px 200px', animationDuration: '40s' }}>
                ...
                <circle cx="360" cy="200" r="14" fill="var(--color-white-mb)" stroke="#cbd5e1" strokeWidth="2" />
                <circle cx="200" cy="360" r="14" fill="var(--color-black-mb)" />
                <circle cx="40" cy="200" r="14" fill="var(--color-additive-mb)" />
                
                <line x1="200" y1="40" x2="200" y2="360" stroke="var(--border-secondary)" strokeWidth="1.5" opacity="0.4" />
                <line x1="40" y1="200" x2="360" y2="200" stroke="var(--border-secondary)" strokeWidth="1.5" opacity="0.4" />
              </g>
              
              {/* Central Reactor */}
              <circle cx="200" cy="200" r="45" fill="var(--bg-glass-heavy)" stroke="url(#glowG)" strokeWidth="4" />
              <text x="200" y="206" textAnchor="middle" fontFamily="var(--font-heading)" fontWeight="900" fontSize="16" fill="var(--text-primary)">MD TECH</text>
            </svg>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="product-tabs-wrapper flex-center">
            ...
            <button className={`tab-btn ${activeTab === 'additive' ? 'active' : ''}`} onClick={() => setActiveTab('additive')}>
        ...
        <div className="container grid-2 rd-tech-grid">
          <div className="rd-content">
            ...
            <p className="section-desc" style={{ textAlign: 'left', marginBottom: '2rem' }}>
              Our dedicated testing facility, <strong>MD Tech Research &amp; Innovation Centre (MDTRIC)</strong>, ensures that every polymer compound stands up to rigorous physical and chemical standards before reaching your silos.
            </p>
          ...
          <div className="rd-visuals flex-center">
            <div className="lab-card glass-panel ani-float">
              <div className="lab-card-image-holder">
                {/* Premium SVG representation of polymer viscosity curve */}
                <svg viewBox="0 0 300 200" style={{ width: '100%', height: '100%', fill: 'none' }}>
                  <defs>
                    <linearGradient id="labGlow" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#3b82f6" />
                      <stop offset="100%" stopColor="#fbbf24" />
                    </linearGradient>
                  </defs>
                  <rect width="300" height="200" fill="#0b0f19" rx="16" />
                  <path d="M 30,170 L 270,170" stroke="rgba(255,255,255,0.05)" strokeWidth="8" strokeLinecap="round" />
                  <path d="M 50,170 C 80,100 120,40 220,100" stroke="url(#labGlow)" strokeWidth="4" strokeLinecap="round" />
                  <circle cx="50" cy="170" r="6" fill="var(--accent-secondary)" />
                  <circle cx="220" cy="100" r="8" fill="var(--color-additive-mb)" />
                  
                  <text x="140" y="30" fill="#475569" fontSize="11" letterSpacing="4" fontWeight="800">POLYMER VISCOSITY CURVE</text>
                  <line x1="80" y1="120" x2="160" y2="120" stroke="#1e293b" strokeWidth="2" strokeDasharray="4 2" />
                </svg>
              </div>
      ...
      {/* 5. Industries Served Grid Section */}
      <section className="section">
        <div className="container">
          <div className="section-header">
