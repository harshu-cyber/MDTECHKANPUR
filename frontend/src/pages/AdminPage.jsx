    ...
    <div className="adm-shell">
      ...
      <main className="adm-main">
        ...
        <div className="adm-content">
                        ...
                        <tr key={app.id}>
                          ...
                          <td>
                            <div className="adm-action-row">
                              ...
                              {app.status !== 'Hired' && (
                                <button className="adm-btn green" onClick={() => updateAppStatus(app.id, 'Hired')}>Hire</button>
                              )}
                              {app.status === 'Hired' && !app.addedToTeam && (
                                <button className="adm-btn gold" onClick={() => addToTeam(app)}>Add to Team</button>
                              )}
          ...
          {activeModule === 'assign' && (
            <div className="adm-module">
              <div className="adm-assign-layout">
                ...
                <div className="adm-assign-log-col">
                  <h2 className="adm-assign-log-title">Assignment Log</h2>
                  {workAssignments.length > 0 ? workAssignments.map(w => (
                    ...
                    <div className="adm-empty-assign">
                      ...
                      <p>No work assignments created yet. Use the form to assign tasks to your team.</p>
                    </div>
                  )}
                </div>
